...
// PASS  ./recursion.test.js
// product
//   ✓ returns the product of all numbers in an array (1ms)
// longest
//   ✓ returns the length of the longest word in an array of words
// everyOther
//   ✓ returns a string with every other character in the input (1ms)
// isPalindrome
//   ✓ returns true if the string is a palindrome
//   ✓ returns false if the string is not a palindrome
// findIndex
//   ✓ returns the first index of the value in the array if the value exists
//   ✓ returns -1 if the value does not exist (1ms)
// revString
//   ✓ returns a reversed copy of the string
// gatherStrings
//   ✓ gathers all object string values into an array
//   ✓ handles nested objects (1ms)
// binarySearch
//   ✓ should find the index of a value in a sorted array
...
// Ran all test suites matching /recursion.test.js/i.